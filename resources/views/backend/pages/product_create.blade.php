    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card" style="border-radius: 15px;">
                ...
                @endif
                <form action="{{ route('product.store') }}" method="post" id="productCreate" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row align-items-center pt-2 pb-1"> <!--row Start -->
                            ...
                            <div class="col-md-10 pe-5">
                                <input type="text" name="product_title" class="form-control form-control-lg"
                                    placeholder="Product Title" value="{{ old('product_title') }}" required />
                            </div>
                        </div> <!--row end -->
                        <hr class="mx-n3">
                        ...
                        <div class="row align-items-center pt-2 pb-1"> <!--row Start -->
                            ...
                            <div class="col-md-10 pe-5">
                                <input type="text" name="sell_price" class="form-control form-control-lg"
                                    placeholder="Sell Price"  value="{{ old('sell_price') }}" required />
                            </div>
                        </div> <!--row end -->
                        ...
                        <div class="row align-items-center pt-2 pb-1"> <!--row Start -->
                            ...
                            <div class="col-md-10 pe-5">
                                <input type="text" name="stock_quantity" class="form-control form-control-lg"
                                    placeholder="Stock Quantity" value="{{ old('stock_quantity') }}" required />
                            </div>
                        </div> <!--row end -->
